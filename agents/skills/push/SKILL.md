...
5. **Watch CI.** If there are checks enabled for this repository use /loop to check on the status every few minutes. If there are CI failures report them and debug the problem.
